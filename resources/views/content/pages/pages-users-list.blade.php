...
@section('content')
  ...
  <td>
        <img 
            src="${user.profile_image ? '/assets/profile/' + user.profile_image : '/assets/profile/172499948757'}" 
            style="height:35px">
    </td>          
        ...
        function attachButtonListeners() {
            document.querySelectorAll('.edit-btn').forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    document.getElementById('phone_number').value = phonenumber === "null" ? '' :
                        phonenumber;
